...
def audio_lsb_encode(message):
    # add a end of transmission character to the end of the message
    EOT = chr(4)
    message = message + EOT
    #print(len(message)) chars=2060479, max_bits=17616480, len_of_bit_array=16483832
    ...
    orig_file_name = "Tartaglia1.wav"
    new_file_name = "media/lsb_" + orig_file_name

    i=0
    # open the original audio file
    with sf.SoundFile(orig_file_name, "r") as audio:
        ...
        if len(bit_array) > max_bits:
            ...
            return 1
        print(audio.frames,len(audio_data), len(bit_array))
        ...
        if audio.format == "FLAC":
            orig_audio = FLAC(orig_file_name)
